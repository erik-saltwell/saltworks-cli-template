...
from {{ cookiecutter.package_name }}.console.main import app
...
def _dist_name() -> str:
    ...
    dists = mapping.get("{{ cookiecutter.package_name }}") or []
    return dists[0] if dists else "{{ cookiecutter.project_slug }}"
